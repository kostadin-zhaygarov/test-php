...
/**
     ...
     * @param  \kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountRB $create_coins_transaction_from_address_for_whole_amount_rb create_coins_transaction_from_address_for_whole_amount_rb (optional)
     ...
     * @return \kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountR|\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount400Response|\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount403Response|\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response
     */
     ...
     * @param  string $wallet_id Represents the sender&#39;s specific and unique Wallet ID of the sender. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountRB $create_coins_transaction_from_address_for_whole_amount_rb (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createCoinsTransactionFromAddressForWholeAmount'] to see the possible values for this operation
     *
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountR|\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount400Response|\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount403Response|\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCoinsTransactionFromAddressForWholeAmountWithHttpInfo($address, $blockchain, $network, $wallet_id, $context = null, $create_coins_transaction_from_address_for_whole_amount_rb = null, string $contentType = self::contentTypes['createCoinsTransactionFromAddressForWholeAmount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountR' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountR' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountR', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount401Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 402:
                ...
                case 403:
                    if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount403Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount403Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount403Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount409Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountR';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmountR',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount403Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionFromAddressForWholeAmount409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $wallet_id Represents the sender&#39;s specific and unique Wallet ID of the sender. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateCoinsTransactionRequestFromAddressRB $create_coins_transaction_request_from_address_rb create_coins_transaction_request_from_address_rb (optional)
     ...
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \kocetestpack\Model\CreateCoinsTransactionRequestFromAddressR|\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress400Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress403Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response
     */
     ...
     * @param  string $wallet_id Represents the sender&#39;s specific and unique Wallet ID of the sender. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateCoinsTransactionRequestFromAddressRB $create_coins_transaction_request_from_address_rb (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createCoinsTransactionRequestFromAddress'] to see the possible values for this operation
     *
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \kocetestpack\Model\CreateCoinsTransactionRequestFromAddressR|\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress400Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress403Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCoinsTransactionRequestFromAddressWithHttpInfo($address, $blockchain, $network, $wallet_id, $context = null, $create_coins_transaction_request_from_address_rb = null, string $contentType = self::contentTypes['createCoinsTransactionRequestFromAddress'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddressR' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddressR' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddressR', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress401Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 402:
                ...
                case 403:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress403Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress403Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress403Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress409Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddressR';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddressR',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddress409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $wallet_id Represents the sender&#39;s specific and unique Wallet ID of the sender. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateCoinsTransactionRequestFromWalletRB $create_coins_transaction_request_from_wallet_rb create_coins_transaction_request_from_wallet_rb (optional)
     ...
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \kocetestpack\Model\CreateCoinsTransactionRequestFromWalletR|\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet400Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet403Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response
     */
     ...
     * @param  string $wallet_id Represents the sender&#39;s specific and unique Wallet ID of the sender. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateCoinsTransactionRequestFromWalletRB $create_coins_transaction_request_from_wallet_rb (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createCoinsTransactionRequestFromWallet'] to see the possible values for this operation
     *
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \kocetestpack\Model\CreateCoinsTransactionRequestFromWalletR|\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet400Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet403Response|\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCoinsTransactionRequestFromWalletWithHttpInfo($blockchain, $network, $wallet_id, $context = null, $create_coins_transaction_request_from_wallet_rb = null, string $contentType = self::contentTypes['createCoinsTransactionRequestFromWallet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWalletR' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWalletR' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromWalletR', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet401Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 402:
                ...
                case 403:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet403Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet403Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet403Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet409Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\kocetestpack\Model\CreateCoinsTransactionRequestFromWalletR';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromWalletR',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet403Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateCoinsTransactionRequestFromWallet409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB $create_fungible_token_transaction_request_from_address_without_fee_priority_rb create_fungible_token_transaction_request_from_address_without_fee_priority_rb (optional)
     ...
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR|\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response|\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response|\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response
     */
     ...
     * @param  string $wallet_id Defines the unique ID of the Wallet. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB $create_fungible_token_transaction_request_from_address_without_fee_priority_rb (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFungibleTokenTransactionRequestFromAddressWithoutFeePriority'] to see the possible values for this operation
     *
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR|\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response|\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response|\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createFungibleTokenTransactionRequestFromAddressWithoutFeePriorityWithHttpInfo($blockchain, $network, $sender_address, $wallet_id, $context = null, $create_fungible_token_transaction_request_from_address_without_fee_priority_rb = null, string $contentType = self::contentTypes['createFungibleTokenTransactionRequestFromAddressWithoutFeePriority'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 402:
                ...
                case 403:
                    if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $wallet_id Defines the unique ID of the Wallet. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressRB $create_fungible_tokens_transaction_request_from_address_rb create_fungible_tokens_transaction_request_from_address_rb (optional)
     ...
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressR|\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress400Response|\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress403Response|\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response
     */
     ...
     * @param  string $wallet_id Defines the unique ID of the Wallet. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressRB $create_fungible_tokens_transaction_request_from_address_rb (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createFungibleTokensTransactionRequestFromAddress'] to see the possible values for this operation
     *
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressR|\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress400Response|\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress403Response|\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createFungibleTokensTransactionRequestFromAddressWithHttpInfo($blockchain, $network, $sender_address, $wallet_id, $context = null, $create_fungible_tokens_transaction_request_from_address_rb = null, string $contentType = self::contentTypes['createFungibleTokensTransactionRequestFromAddress'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressR' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressR' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressR', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress401Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 402:
                ...
                case 403:
                    if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress403Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress403Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress403Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress409Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressR';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddressR',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateFungibleTokensTransactionRequestFromAddress409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $wallet_id Represents the sender&#39;s specific and unique Wallet ID of the sender. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB $create_single_transaction_request_from_address_without_fee_priority_rb create_single_transaction_request_from_address_without_fee_priority_rb (optional)
     ...
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityR|\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response|\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response|\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response
     */
     ...
     * @param  string $wallet_id Represents the sender&#39;s specific and unique Wallet ID of the sender. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB $create_single_transaction_request_from_address_without_fee_priority_rb (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createSingleTransactionRequestFromAddressWithoutFeePriority'] to see the possible values for this operation
     *
     * @throws \kocetestpack\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityR|\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response|\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response|\kocetestpack\Model\CreateNewMasterWallet402Response|\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response|\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response|\kocetestpack\Model\CreateNewMasterWallet415Response|\kocetestpack\Model\CreateNewMasterWallet422Response|\kocetestpack\Model\CreateNewMasterWallet429Response|\kocetestpack\Model\CreateNewMasterWallet500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSingleTransactionRequestFromAddressWithoutFeePriorityWithHttpInfo($address, $blockchain, $network, $wallet_id, $context = null, $create_single_transaction_request_from_address_without_fee_priority_rb = null, string $contentType = self::contentTypes['createSingleTransactionRequestFromAddressWithoutFeePriority'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityR' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityR' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityR', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 402:
                ...
                case 403:
                    if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 415:
            ...
            $returnType = '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityR';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityR',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority403Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kocetestpack\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriority409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
