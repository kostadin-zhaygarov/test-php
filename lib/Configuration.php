...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://rest.vaultody.com';
    ...
    {
        $report  = 'PHP SDK (kocetestpack) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2023-04-20' . PHP_EOL;
