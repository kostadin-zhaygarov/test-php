...
/**
 * BannedIpAddressDetailsInner Class Doc Comment
 *
 * @category Class
 * @package  kocetestpack
 * @author   OpenAPI Generator team
 ...
 */
class BannedIpAddressDetailsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BannedIpAddress_details_inner';
    ...
    */
     ...
     * Sets attribute
     *
     * @param string $attribute Specifies an attribute of the error by name.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message Specifies the details of an attribute as part from the error.
     *
     * @return self
     */
