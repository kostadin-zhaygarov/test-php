...
/**
 * CreateNewMasterWalletRI Class Doc Comment
 *
 * @category Class
 * @package  kocetestpack
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewMasterWalletRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateNewMasterWalletRI';
    ...
    */
     ...
     * Sets wallet_id
     *
     * @param string $wallet_id Represents the sender's specific and unique Wallet ID of the sender.
     *
     * @return self
     */
