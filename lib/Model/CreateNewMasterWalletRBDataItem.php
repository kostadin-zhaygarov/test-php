...
/**
 * CreateNewMasterWalletRBDataItem Class Doc Comment
 *
 * @category Class
 * @package  kocetestpack
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewMasterWalletRBDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateNewMasterWalletRB_data_item';
    ...
    public const WALLET_TYPE_MAIN = 'main';
    public const WALLET_TYPE_TEST = 'test';
    ...
    {
        return [
            self::WALLET_TYPE_MAIN,
            self::WALLET_TYPE_TEST,
        ];
    }
    ...
    */
     ...
     * Sets wallet_name
     *
     * @param string $wallet_name Defines the name of the wallet that will be generated.
     *
     * @return self
     */
     ...
     * Sets wallet_type
     *
     * @param string $wallet_type Represents if the generated wallet is only for mainnet or only for testnet .
     *
     * @return self
     */
