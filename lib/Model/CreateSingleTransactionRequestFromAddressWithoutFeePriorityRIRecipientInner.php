...
/**
 * CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner Class Doc Comment
 *
 * @category Class
 * @package  kocetestpack
 * @author   OpenAPI Generator team
 ...
 */
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSingleTransactionRequestFromAddressWithoutFeePriorityRI_recipient_inner';
    ...
    */
     ...
     * Sets unit
     *
     * @param string $unit Defines the unit of the recieved amount for the address.
     *
     * @return self
     */
