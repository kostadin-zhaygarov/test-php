...
class CreateCoinsTransactionRequestFromAddressRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fee_priority' => 'string',
        'note' => 'string',
        'recipients' => '\kocetestpack\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[]',
    ...
    */
     ...
     * Gets recipients
     *
     * @return \kocetestpack\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[]
     */
     ...
     * Sets recipients
     *
     * @param \kocetestpack\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[] $recipients Defines the destination for the transaction, i.e. the recipient(s).
     *
     * @return self
     */
