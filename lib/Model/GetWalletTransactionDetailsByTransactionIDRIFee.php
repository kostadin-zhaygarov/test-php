...
/**
 * GetWalletTransactionDetailsByTransactionIDRIFee Class Doc Comment
 *
 * @category Class
 * @package  kocetestpack
 * @author   OpenAPI Generator team
 ...
 */
class GetWalletTransactionDetailsByTransactionIDRIFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetWalletTransactionDetailsByTransactionIDRI_fee';
    ...
    */
     ...
     * Sets unit
     *
     * @param string $unit Represents the unit of the fee.
     *
     * @return self
     */
