...
class GetTransactionRequestDetailsRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fee_priority' => 'string',
        'network' => 'string',
        'recipients' => '\kocetestpack\Model\GetTransactionRequestDetailsRIRecipientsInner[]',
    ...
    public const BLOCKCHAIN_BITCOIN = 'bitcoin';
    public const BLOCKCHAIN_BITCOIN_CASH = 'bitcoin-cash';
    public const BLOCKCHAIN_LITECOIN = 'litecoin';
    public const BLOCKCHAIN_DOGECOIN = 'dogecoin';
    public const BLOCKCHAIN_DASH = 'dash';
    public const BLOCKCHAIN_ETHEREUM = 'ethereum';
    public const BLOCKCHAIN_ETHEREUM_CLASSIC = 'ethereum-classic';
    public const BLOCKCHAIN_XRP = 'xrp';
    public const BLOCKCHAIN_ZCASH = 'zcash';
    ...
    public const NETWORK_ROPSTEN = 'ropsten';
    public const NETWORK_MORDOR = 'mordor';
    ...
    public const TRANSACTION_TYPE_TOKEN = 'token';
    ...
    */
     ...
     * Gets recipients
     *
     * @return \kocetestpack\Model\GetTransactionRequestDetailsRIRecipientsInner[]
     */
     ...
     * Sets recipients
     *
     * @param \kocetestpack\Model\GetTransactionRequestDetailsRIRecipientsInner[] $recipients Represents a list of recipient addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.
     *
     * @return self
     */
