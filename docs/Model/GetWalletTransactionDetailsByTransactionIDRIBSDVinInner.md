...
**script_sig** | [**\kocetestpack\Model\GetWalletTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig**](GetWalletTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig.md) |  |
